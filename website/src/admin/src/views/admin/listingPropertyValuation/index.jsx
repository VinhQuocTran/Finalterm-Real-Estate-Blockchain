...
import {
    ListingPropertyInpectionColumnsData
} from "./variables/ListingPropertyInpectionColumnsData";
import config from '../../../config.json';
import ListingPropertyInpectionTable from "./components/ListingPropertyInpectionTable";
function fetchListingPropertyData() {
    return fetch(config.API_URL+"listingPropertyValuations")
        .then((response) => {
            if (!response.ok) {
  ...
  return (
    <Box pt={{ base: "130px", md: "80px", xl: "80px" }}>
      <SimpleGrid
        ...
        <ListingPropertyInpectionTable
          columnsData={ListingPropertyInpectionColumnsData}
